...
Under the path ``~/environment/ako2020-lucky-money/amplify/backend/function/LuckyMoneyFunction/src``, add a new file called `lambda_function.py`. Add the following code in **lambda_function.py**.
...
**Save** the lambda_function.py file. Next, open the **~/environment/ako2020-lucky-money/amplify/backend/function/LuckyMoneyFunction/LuckyMoneyFunction-cloudformation-template.json** file and make these very specific changes:
